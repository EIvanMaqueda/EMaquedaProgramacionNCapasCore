...
namespace PL.Controllers
{
    ...
    public class CargaMasivaController : Controller
    {
        ...
        {
            ViewBag.Sesion = HttpContext.Session.GetString("Usuario");
            IFormFile archivo = Request.Form.Files["TExcel"];
                    ...
                    if (extensionArchivo == extensionModulo) //validando que sea un archivo excel
                    {
                        ...
                        if (!System.IO.File.Exists(filePath))
                        {
                            ...
                            if (resultUsuarios.Correct)
                            {
                                ...
                                ViewBag.Session = HttpContext.Session.GetString("PathArchivo");
            ...
            else
            {
                ...
                if (resultData.Correct)
                {
                    ...
                    foreach (ML.Usuario usuarioItem in resultData.Objects)
                    {
                        ...
                        {
                            resultErrores.Objects.Add("No se insertó el Usuario con Username: " + usuarioItem.UserName + " nombre:" + usuarioItem.Nombre + "Apellidos:" + usuarioItem.ApellidoPaterno+" "+usuario.ApellidoMaterno + " Error: " + resultAdd.Message);
                        }
                    }
